    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li>
                    <a href="family_dasborad.php"  data-page="family-resources">
                        <i class="fas fa-users"></i> Family Resources
                    </a>
                </li>
                <li>
                    <a href="today_dasborad.php" data-page="past-devotions">
                ...
                <li>
                  ...
                  <li>
                    <a href="subscribers.php"  data-page="prayer-requests">
                        <i class="fas fa-pray"></i> Subscribers
                    </a>
                </li>
                <li>
                    <a href="login.php">
